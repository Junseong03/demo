...
- `400 Bad Request`: 승인 대기중입니다 (이미 PENDING 상태의 가입 신청이 있는 경우)
- `404 Not Found`: 동아리를 찾을 수 없습니다
- `404 Not Found`: 사용자를 찾을 수 없습니다
...
**에러 응답:**
- `400 Bad Request`: 회장, 부회장, 관리자만 활동 사진을 업로드할 수 있습니다
- `400 Bad Request`: 동아리 부원이 아닙니다
- `400 Bad Request`: 파일이 비어있습니다
- `400 Bad Request`: 이미지 파일만 업로드 가능합니다
- `404 Not Found`: 동아리를 찾을 수 없습니다
...
**참고:**
- 회장(PRESIDENT), 부회장(VICE_PRESIDENT), 관리자(ADMIN)만 업로드 가능
- MinIO를 사용하여 파일을 저장합니다.
...
**에러 응답:**
- `400 Bad Request`: 회장, 부회장, 관리자만 활동 사진을 업데이트할 수 있습니다
- `400 Bad Request`: 동아리 부원이 아닙니다
- `400 Bad Request`: 해당 동아리의 활동이 아닙니다
- `400 Bad Request`: 파일이 비어있습니다
- `400 Bad Request`: 이미지 파일만 업로드 가능합니다
...
**참고:**
- 회장(PRESIDENT), 부회장(VICE_PRESIDENT), 관리자(ADMIN)만 업데이트 가능
...
**에러 응답:**
- `400 Bad Request`: 회장, 부회장, 관리자만 활동 사진을 삭제할 수 있습니다
- `400 Bad Request`: 동아리 부원이 아닙니다
- `400 Bad Request`: 해당 동아리의 활동이 아닙니다
- `404 Not Found`: 동아리를 찾을 수 없습니다
- `404 Not Found`: 활동을 찾을 수 없습니다
...
**참고:**
- 회장(PRESIDENT), 부회장(VICE_PRESIDENT), 관리자(ADMIN)만 삭제 가능
- `imageId`는 활동 상세 조회 응답의 `images` 배열에서 확인할 수 있습니다
...
**Query Parameters:**
- `userId`: 사용자 ID (회장 또는 채팅방의 일반 사용자)
- `page` (optional, default: 0): 페이지 번호
- `size` (optional, default: 100): 페이지 크기
...
**에러 응답:**
- `400 Bad Request`: 회장이나 채팅방의 사용자만 메시지를 조회할 수 있습니다
- `404 Not Found`: 채팅방을 찾을 수 없습니다
- `404 Not Found`: 동아리 회장을 찾을 수 없습니다

**참고:**
- 동아리 회장 또는 채팅방의 일반 사용자(비회원)만 조회 가능합니다.
...
**Query Parameters:**
- `userId`: 전송하는 사용자 ID (회장 또는 채팅방의 일반 사용자)
...
**에러 응답:**
- `400 Bad Request`: 회장이나 채팅방의 사용자만 메시지를 전송할 수 있습니다
- `404 Not Found`: 채팅방을 찾을 수 없습니다
- `404 Not Found`: 사용자를 찾을 수 없습니다
- `404 Not Found`: 동아리 회장을 찾을 수 없습니다

**참고:**
- 동아리 회장 또는 채팅방의 일반 사용자(비회원)만 전송 가능합니다.
- 일반 사용자는 자신이 생성한 채팅방에서만 메시지를 보낼 수 있습니다.
